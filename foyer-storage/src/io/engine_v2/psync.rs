...
impl PsyncIoEngineConfig {
    ...
    /// Set the runtime spawner for the I/O engine.
    ...
    fn read(&self, buf: Box<dyn IoBufMut>, raw: RawFile, offset: u64) -> IoHandle<Box<dyn IoBufMut>> {
        ...
        async move {
                ...
                .await
            {
                ...
                Err(e) => return (Box::new(Raw::new(0)) as Box<dyn IoBufMut>, Err(e)),
            };
            (buf, res)
        }
        .boxed()
    ...
    fn write(&self, buf: Box<dyn IoBuf>, raw: RawFile, offset: u64) -> IoHandle<Box<dyn IoBuf>> {
        ...
        async move {
                ...
                .await
            {
                ...
                Err(e) => return (Box::new(Raw::new(0)) as Box<dyn IoBuf>, Err(e)),
            };
            (buf, res)
        }
        .boxed()
